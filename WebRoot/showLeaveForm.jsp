					...
					<div class="col-md-8">
						<div class="panel-body" style="padding-bottom:0px;">
							<div class="panel panel-default">
								<div class="panel-heading">查看请假条</div>
									...
									<form>
										...
										<div class="form-group">
											...
											<div class="input-group date form_date" id='datetimepicker4'>
												<input class="form-control" size="16" type="text" placeholder="${requestScope.leaveForm.leFStarttime}" disabled="">
										...
										<div class="form-group">
											...
											<div class="input-group date form_date" id='datetimepicker3'>
												<input class="form-control" size="16" type="text" placeholder="${requestScope.leaveForm.leFEndtime}" disabled="">
												<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
												<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
											</div>
										</div>
										...
										<div class="form-group">
											<label>请假理由</label>
											<textarea class="form-control" rows="3" placeholder="${requestScope.leaveForm.leFReason}" disabled=""></textarea>
										</div>
									</form>
									<hr />
