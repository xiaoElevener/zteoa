					...
					<div class="col-md-8">
						<div class="panel-body" style="padding-bottom:0px;">
							<div class="panel panel-default">
								<div class="panel-heading">审批加班申请单</div>
									...
									<div class="form-group">
										...
										<div class="input-group date form_date" id='datetimepicker4'>
											<input class="form-control" size="16" type="text"
												placeholder="${requestScope.overtimeForm.otFDate}" disabled="">
								...
								<form action="${pageContext.request.contextPath }/chaim_checkChaim" method="post">
									<input name="chaim_id" type="hidden" value="${requestScope.overtimeForm.chaimVovcher.cvId}">
									<h3>审批人决定</h3>
									<div class="form-group">
										<div class="radio">
