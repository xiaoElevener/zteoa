					...
					<div class="col-md-8">
						<div class="panel-body" style="padding-bottom:0px;">
							<div class="panel panel-default">
								<div class="panel-heading">在这里，你可以管理自己的通讯录</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="" id="addContactsForm" method="post">
							<div class="form-group">
								<label >联系人名称</label>
								<input type="text" class="form-control"  placeholder="联系人名称" name ="addressBook.abName">
							</div>
							<div class="form-group">
								<label >联系人部门</label>
								<input type="text" class="form-control"  placeholder="联系人部门" name ="addressBook.abDepartment">
							</div>
							<div class="form-group">
								<label >联系人角色</label>
								<input type="text" class="form-control" placeholder="联系人角色" name ="addressBook.abRole">
							</div>
							<div class="form-group">
								<label >联系方式</label>
								<input type="" class="form-control" placeholder="联系方式" name ="addressBook.abTelephone">
							</div>
						</form>
					</div>
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" id="addContacts" data-dismiss="modal">
							提交
						</button>
					</div>
				</div>
...
<script type="text/javascript">
		...
		$('#table').bootstrapTable({
			...
			url: "${pageContext.request.contextPath }/contacts_findAll",
			columns: [{
				checkbox: true
			}, {
				field: 'abId',
			...
			onEditableSave: function (field, row, oldValue, $el) {
	            ...
	            var newrow = JSON.stringify(row);
	             ...
	             $.ajax({
	                type: "post",
	                url: "${pageContext.request.contextPath }/contacts_updateContacts",
	                data: {"myrow": newrow},
	                //dataType: 'JSON',
	                success: function() {
		...
		$("#addContacts").click(function() {
			...
			$.ajax({
				type:"post",
				url:"${pageContext.request.contextPath }/contacts_addContacts",
				//提交表单中序列化的值
			...
			swal({
				...
				function(isConfirm) {
					if(isConfirm) {
						...
						$.ajax({
							type: "post",
							url: "${pageContext.request.contextPath }/contacts_deleteContacts",
							//提交表单中序列化的值
