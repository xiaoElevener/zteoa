					...
					<div class="col-md-8">
						<div class="panel-body" style="padding-bottom:0px;">
							<div class="panel panel-default">
								<div class="panel-heading">管理员，在这里管理角色</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="${pageContext.request.contextPath }/" id="addRoleForm" method="post">
							<div class="form-group">
								<label for="depName">角色名称</label>
								<input type="text" class="form-control" id="depName" placeholder="角色" name ="role.roleName">
							</div>
						</form>
					</div>
...
<script type="text/javascript">
		...
		$('#table').bootstrapTable({
			...
			url: "${pageContext.request.contextPath }/role_find",
			columns: [{
				checkbox: true
			}, {
				field: 'roleId',
			...
			onEditableSave: function (field, row, oldValue, $el) {
	            ...
	            var newrow = JSON.stringify(row);
	             ...
	             $.ajax({
	                type: "post",
	                url: "${pageContext.request.contextPath }/role_updateRole",
	                data: {"myrow": newrow},
	                //dataType: 'JSON',
	                success: function() {
		...
		$("#addDep").click(function() {
			...
			$.ajax({
				type:"post",
				url:"${pageContext.request.contextPath }/role_addRole",
				//提交表单中序列化的值
			...
			swal({
				...
				function(isConfirm) {
					if(isConfirm) {
						...
						$.ajax({
							type: "post",
							url: "${pageContext.request.contextPath }/role_deleteRole",
							//提交表单中序列化的值
