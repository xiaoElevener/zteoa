...
<html>
    ...
    <!--个人通讯录的网页-->
					...
					<div class="col-md-8">
						<div class="panel-body" style="padding-bottom:0px;">
							<div class="panel panel-default">
								<div class="panel-heading">对所有员工个人经历进行管理</div>
		...
		$('#table').bootstrapTable({
			...
			url: "${pageContext.request.contextPath }/userHistory_findByUser",
			columns: [{
				checkbox: true
			}, {
				field: 'uhId',
			...
			onEditableSave : function(field, row, oldValue, $el) {
							...
							$
									.ajax({
										type : "post",
										url : "${pageContext.request.contextPath }/userHistory_updateUserHistory",
										data : {
											"myrow" : newrow
										},
										//dataType: 'JSON',
			...
			swal({
				...
				function(isConfirm) {
					if(isConfirm) {
						...
						$.ajax({
							type: "post",
							url: "${pageContext.request.contextPath }/userHistory_deleteUserFamily",
							//提交表单中序列化的值
